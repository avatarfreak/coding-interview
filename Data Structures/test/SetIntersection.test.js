import Set from "../SetIntersection";
...
test("The intersect method should include common elements both setA and SetB ", () => {
  setB.add(2);
  setB.add(1);
  setB.add(5);
 
  expect(setA.intersection(setB).values()).toEqual([1]);
});
